...
import { HomeOutlined, GlobalOutlined, BarChartOutlined, SettingOutlined, LoginOutlined, UserOutlined, FileTextOutlined } from '@ant-design/icons';
...
const baseItems = [
  ...
  { key: '/dashboard', icon: <BarChartOutlined />, label: <Link to="/dashboard">Statistiques</Link> },
  { key: '/conformance', icon: <FileTextOutlined />, label: <Link to="/conformance">Conformité</Link> }
];
...
export default function AppLayout() {
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      <Header style={{ display: 'flex', alignItems: 'center', position: 'sticky', top: 0, zIndex: 999, boxShadow: '0 2px 8px rgba(0,0,0,0.15)' }}>
